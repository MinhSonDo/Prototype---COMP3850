import { questionSet3 as QuestionSet3 } from '../../static/questionMock'
...
function Set3() {
	...
	if (count < QuestionSet3.length) {
		return (
			<div>
				<p className="title"> {QuestionSet3[count].question}</p>
				<div className="buttons is-centered">
					<p>
						<button className="button" onClick={aClick}>
							{QuestionSet3[count].answers[0]}{' '}
						</button>{' '}
					</p>
					<p>
						{' '}
						<button className="button" onClick={bClick}>
							{QuestionSet3[count].answers[1]}{' '}
						</button>{' '}
					</p>
					<p>
						{' '}
						<button className="button" onClick={cClick}>
							{' '}
							{QuestionSet3[count].answers[2]}{' '}
						</button>{' '}
					</p>
					<p>
						<button className="button" onClick={dClick}>
							{' '}
							{QuestionSet3[count].answers[3]}{' '}
						</button>{' '}
					</p>
				</div>
		...
		if (score / QuestionSet3.length < 0.5) {
			return (
				<div>
					...
					<p>
						Final Score is {score} out of {QuestionSet3.length}{' '}
					</p>
					<br></br>
					<div className="App">
						<p>
